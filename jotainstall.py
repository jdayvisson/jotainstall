...
seeker = 'sudo apt update; sudo git clone https://github.com/thewhiteh4t/seeker; cd seeker; sudo chmod 777 install.sh; sudo ./install.sh; cd seeker; sudo python seeker'
